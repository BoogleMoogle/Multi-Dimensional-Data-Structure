...
# points = make_points(num=256,sprout=8,aRang=0,bRang=500)       #may need to change sorting method
# points = make_points(num=2032,sprout=2,aRang=0,bRang=30)
points = make_points(num=1024,sprout=2,aRang=0,bRang=100)
temp = KDTree(points)
# temp.print_tree()
# temp.graph_tree()                     #reason for memory useage being high, flat it needs 100MB to operate


# print(len(temp.nBRC(122,193,195,493)))
# for item in block:
#     print(item)
# print("\n\n\n")
# print(temp.BRC(122,193,195,493))

# pd.set_option('display.max_colwidth',None)
# save_query(temp, num=10, sprout=8, save=False, show=False, BRC=True)
...
# i=0
# for item in points:
#     if item[0] >= 113 and item[0] <= 265 and item[1] >= 206 and item[1] <= 329:
#         i+=1
# print(i)
...
# print(temp.points)
# print(temp.left.points)
# print(temp.left.left.points)
# print(temp.left.left.left.points)
# print(temp.left.left.left.left.points)
